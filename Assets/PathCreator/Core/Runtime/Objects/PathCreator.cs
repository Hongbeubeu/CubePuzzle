...
namespace PathCreation
{
    public class PathCreator : MonoBehaviour
    {
        ...
        [SerializeField, HideInInspector] protected PathCreatorData editorData;
        [SerializeField, HideInInspector] protected bool initialized;

        protected GlobalDisplaySettings globalEditorDisplaySettings;
